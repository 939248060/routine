...
/***/ 15:
/*!**************************************************!*\
  !*** D:/HBuilderProjects/routine/store/index.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 17:
/*!*************************************************!*\
  !*** D:/HBuilderProjects/routine/utils/util.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var StringUtil = __webpack_require__(/*! ../utils/stringUtil.js */ 18);
...
module.exports = _defineProperty({
  ...
  getWeek: getWeek }, "getWeek", getWeek);
...
/***/ 18:
/*!*******************************************************!*\
  !*** D:/HBuilderProjects/routine/utils/stringUtil.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function isMobile(value) {
  var eg = /^(((13[0-9]{1})|(15[0-9]{1})|(17[0-9]{1})|(18[0-9]{1})|(19[0-9]{1}))+\d{8})$/;
...
/***/ 19:
/*!****************************************************!*\
  !*** D:/HBuilderProjects/routine/utils/request.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var app = getApp();
...
function postToken(url, data) {
  ...
  return new Promise(function (resolve, reject) {
    uni.request({
      url: app.globalData.host + url, method: 'POST', data: _objectSpread({}, data),
      ...
      success: function success(res) {
        if (res.statusCode === 200) {
          ...
          if (res.statusCode === 401) {
            ...
            var err = "发生错误：" + res.statusCode;
            reject(err); //其它错误，提示用户错误信息
          }
        }
      },
      fail: function fail(err) {
        var msg = err.errMsg != null ? err.errMsg : err;
        reject(msg);
      } });
...
function postUrl(url, data) {
  return new Promise(function (resolve, reject) {
    uni.request({
      url: url, method: 'POST', data: _objectSpread({}, data),
      header: { 'content-type': 'application/x-www-form-urlencoded; charset=utf-8' },
      success: function success(res) {
        if (res.statusCode === 200) {
          resolve(res); //200: 服务端业务处理正常结束
...
/***/ 4:
/*!**********************************************!*\
  !*** D:/HBuilderProjects/routine/pages.json ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 50:
/*!****************************************************!*\
  !*** D:/HBuilderProjects/routine/utils/amap-wx.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 67:
/*!*************************************************!*\
  !*** D:/HBuilderProjects/routine/utils/area.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
module.exports = {
  // 根据regid查询regname
  regname: function regname(regid) {

  },
  areaInfo: function areaInfo(regid) {
    var data = this.data;
    var result;
    var i;
  ...
  //根据parid查询子数据 列表
  areaParent: function areaParent(parid) {
    var data = this.data;
    var result = [];
    var i;
    var ii = 0;
...
/***/ 7:
/*!***************************************************************!*\
  !*** D:/HBuilderProjects/routine/pages.json?{"type":"style"} ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": { "navigationBarTitleText": "量心回收", "navigationBarBackgroundColor": "#fff", "usingComponents": { "callrecy": "/components/callrecy/callrecy" }, "usingAutoImportComponents": {} }, "pages/login/login": { "navigationBarTitleText": "用户登录", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/wareslist/wareslist": { "navigationBarTitleText": "商城", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/recySmart/recySmart": { "navigationBarTitleText": "智能站分布", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/addresslist/addresslist": { "navigationBarTitleText": "地址列表", "usingComponents": { "dialogs": "/components/dialog/dialog" }, "usingAutoImportComponents": {} }, "pages/addressform/addressform": { "navigationBarTitleText": "添加地址", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/electrical/electrical": { "navigationBarTitleText": "家电回收", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/recyorderlist/recyorderlist": { "navigationBarTitleText": "上面回收", "enablePullDownRefresh": true, "usingComponents": { "dialogs": "/components/dialog/dialog" }, "usingAutoImportComponents": {} }, "pages/qrcode/qrcode": { "navigationBarTitleText": "用户二维码", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/guide/guide": { "navigationBarTitleText": "使用指南", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/personal/personal": { "navigationBarTitleText": "个人中心", "navigationBarBackgroundColor": "#1b82d1", "usingComponents": { "dialogs": "/components/dialog/dialog" }, "usingAutoImportComponents": {} }, "pages/realname/realname": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/smartorderlist/smartorderlist": { "enablePullDownRefresh": true, "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/furniture/furniture": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/governmentinfo/governmentinfo": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/electricalinfo/electricalinfo": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/furnitureinfo/furnitureinfo": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/merchantinfo/merchantinfo": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/dryorderlist/dryorderlist": { "enablePullDownRefresh": true, "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/exchangelist/exchangelist": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/wares/wares": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/exchange/exchange": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/invitation/invitation": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/withdraw/withdraw": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/getuserinfo/getuserinfo": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/scorelist/scorelist": { "enablePullDownRefresh": true, "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/scoredetails/scoredetails": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/cashlist/cashlist": { "enablePullDownRefresh": true, "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/dryorderinfo/dryorderinfo": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/smartorderinfo/smartorderinfo": { "usingComponents": {}, "usingAutoImportComponents": {} } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "量心回收", "navigationBarBackgroundColor": "#00a2ed", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),

/***/ 76:
/*!***************************************************!*\
  !*** D:/HBuilderProjects/routine/utils/pinyin.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 8:
/*!**************************************************************!*\
  !*** D:/HBuilderProjects/routine/pages.json?{"type":"stat"} ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 93:
/*!*****************************************************!*\
  !*** D:/HBuilderProjects/routine/utils/wxqrcode.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
