<template>
	<view class="content">
		...
		<view class="m10 column">
			...
			<text class="">
				(1). 签到代表您在量心小程序上的成就，去每天签到可获得签到奖励，连续签到7天可获得终极礼品奖励；
				(2). 签到奖励分每日签到奖励和一周连续签到奖励；
				(3). 连续签到计算方式为：每周一到周日连续、不间断的签到天数；
				(4). 连续签到达到指定的天数，才可获得签到的奖励；
				(5). 连续签到天数为一周，每周一到周日，用户每天0:00——23:59:59登录量心回收小程序，进入签到页面，连续签到7天后，会获取礼品一份。
			</text>
		</view>
		<!-- 签到奖励弹窗 -->
