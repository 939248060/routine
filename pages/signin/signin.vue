<template>
	<view class="content">
		...
		<view class="m10 column">
			...
			<text class="">
				1、签到代表您在量心小程序上的成就，连续签到7天可获得终极礼品奖励；
				2、连续签到计算方式为：每周一到周日连续、不间断的签到天数；
				3、连续签到天数为一周，每周一到周日，用户每天0:00——23:59:59登录量心回收小程序，进入签到页面，连续签到7天后，会获取礼品一份；
				4、最终解释权归海南省量心环保科技有限公司所有。
			</text>
		</view>
		<!-- 签到奖励弹窗 -->
