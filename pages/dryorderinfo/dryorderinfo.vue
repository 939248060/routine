	...
	<view class="m10">
		...
		<view class="mt10 bg-white radius8 black f15">
		  ...
		  <view class="row jcbetween aicenter p10">
		    ...
		    <view class="txtright">
		      <view class="f16">￥{{single.expTotalScore?single.expTotalScore:'--'}}量心币</view>
		      <view class="gray f13">{{single.expScore?single.expScore:'--'}}<text class="ml2 let1">量心币/KG</text></view>
		    </view>    
		  </view>
		...
		<view v-if="single.state>2" class="mt10 bg-white radius8 black f15">
		  ...
		  <view v-if="single.state==3" class="row jcbetween aicenter pt5 pl10 pr10">
		    ...
		    <view class="txtright">
		      <view class="red f16">￥{{single.actTotalScore?single.actTotalScore:'--'}}量心币</view>
		      <view class="gray f13">{{single.actScore?single.actScore:'--'}}<text class="ml2 let1">量心币/KG</text></view>
		    </view>    
		  </view>
		  <!--异常标签-->
		...
		<view class="mt10 bg-white radius8">
		  ...
		  <!--投放站点-->
		  <view class="serialsingle"><view>投放站点</view><view>{{single.boxName}}</view></view>
		  <!--站点位置-->
